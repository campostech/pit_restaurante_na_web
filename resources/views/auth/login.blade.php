            ...
            <div class="col-md-5">
                <form action="{{ route('user.signin') }}" method="POST" class="form-sub-main">
                    ...
                    <div class="form-group">
                        <input id="email" name="email" class="form-control mb-0" type="text" placeholder="Insira seu email"  required="" aria-required="true">
                    </div>
                    ...
                    <div class="form-group text-right">                      
                        ...
                        <input id="password" type="password" class="form-control mt-0" name="password" placeholder="Insira sua senha"  required="required">
                    </div>
